...
class MaskCycleGANVC_Distesting(object):
    ...
    def __init__(self, args):
        ...
        self.real_voice_level=args.real_voice_level
    ...
    def test(self):
        sum=0
        #阈值：threld ，如果sum_B、A《threld，则为假的语音，否则为真
        threld=self.real_voice_level-self.real_voice_level*0.3
        threld=torch.tensor(threld)
